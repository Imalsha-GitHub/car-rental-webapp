          ...
          {/* Car Year, Price, Category */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              ...
              <div className='flex flex-col w-full'>
                ...
                <input type="number" placeholder='4500' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
            ...
            <div className='flex flex-col w-full'>
                ...
                <textarea rows={5}  placeholder='e.g. A luxurious SUV with a sacious interior and powerful engine.' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
